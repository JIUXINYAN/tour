<?php
/* Smarty version 3.1.29, created on 2018-09-16 18:14:56
  from "D:\usr\Study\project\tour\app\admin\view\User\userEdit.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5b9e2d2080a165_51057882',
  'file_dependency' => 
  array (
    'd53ad933dc6f526fb68f19f89be3e591381b6452' => 
    array (
      0 => 'D:\\usr\\Study\\project\\tour\\app\\admin\\view\\User\\userEdit.html',
      1 => 1537092892,
      2 => 'file',
    ),
  ),
...
function content_5b9e2d2080a165_51057882 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
/index.php?p=admin&m=user&a=updh&id=<?php echo $_smarty_tpl->tpl_vars['row']->value['id'];?>
" method="post" enctype="multipart/form-data"  >	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>账号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['acc'];?>
" placeholder="" id="adminName" name="acc">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<div class="radio-box">
				<input name="sex" type="radio" id="sex-1" value="1" <?php if ($_smarty_tpl->tpl_vars['row']->value['sex'] == 1) {?>checked<?php }?>>
				<label for="sex-1">男</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="sex-2" name="sex" value="0" <?php if ($_smarty_tpl->tpl_vars['row']->value['sex'] == 0) {?>checked<?php }?>>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="type" size="1">
				<option value="1" <?php if ($_smarty_tpl->tpl_vars['row']->value['type'] == 1) {?>selected<?php }?>>管理员</option>
				<option value="0" <?php if ($_smarty_tpl->tpl_vars['row']->value['type'] == 0) {?>selected<?php }?>>普通用户</option>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['row']->value['nickname'];?>
" placeholder="" id="adminName" name="nickname">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">个人简介：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<textarea name="own_intro" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="$.Huitextarealength(this,100)"><?php echo $_smarty_tpl->tpl_vars['row']->value['own_intro'];?>
</textarea>
